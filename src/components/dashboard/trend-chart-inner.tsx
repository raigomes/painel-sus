...
export function TrendChartInner({ data, indicatorName, indicatorFilter }: TrendChartProps) {
  ...
  const descriptionId = 'trend-chart-description-inner';

  return (
    <section aria-labelledby="trend-chart-title-inner" className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
      <h2 id="trend-chart-title-inner" className="text-lg font-semibold text-zinc-800">
        Evolução histórica
      </h2>
